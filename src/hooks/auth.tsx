...
function AuthProvider({ children }: AuthProvideProps) {
        ...
        auth().signInWithEmailAndPassword(email, password)
            .then(account => {
                firestore()
                    ...
                    .catch(() => Alert.alert('Login', 'Não foi possivel buscar os dados do usuário.'));
    ...
    async function forgotPassword(email: string){
        ...
        .catch(()=> Alert.alert('Redefinir senha', 'Não foi possivel enviar o e-mail para redefinir senha' ));
    }
